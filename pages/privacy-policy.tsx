import { privacyPolicy } from "@/lib/utils/constants/privacyPolicy";
...
const PrivacyPolicy = () => {
  return (
    <>
      <Head>
        <title> Privacy Policy | Immerge Therapeutics</title>
        <meta property="og:title" content="Privacy Policy | Immerge Therapeutics" />
      ...
      <section className="container mx-auto max-w-[1200px] p-4 pt-[8rem] pb-[4rem] md:pb-[8rem]">
        ...
        <p>
          <strong>Veritytech Healthcare Solutions Private Limited</strong>{" "}
          (&quot;We,&quot; &quot;Our,&quot; or &quot;Us&quot;) is committed to
          protecting “Your” “You” or “User(s)” privacy.
        </p>
        <p>
            ...
            <div key={index} className="mb-4">
              ...
              {Array.isArray(section.content) ? (
                <ol className="list-inside list-decimal">
                  {section.content.map((item, itemInd) => (
                    <li key={itemInd} className="my-4">
        ...
        {/* <p className="mb-4">Last updated: May 31, 2024</p>
      <p className="mb-4">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mb-2">
          ...
          controlled by or is under common control with a party, where &quotcontrol&quot
          means ownership of 50% or more of the shares, equity interest or other
          securities entitled to vote for election of directors or other
          managing authority.
        </li>
        <li className="mb-2">
          <strong>Company</strong> (referred to as either &quotthe Company&quot, &quotWe&quot,
            &quotUs&quot or &quotOur&quot in this Agreement) refers to Immerge Therapeutics.
        </li>
        <li className="mb-2">
      ...
      <p className="mb-4">
        ...
        prior to the change becoming effective and update the &quotLast updated&quot
